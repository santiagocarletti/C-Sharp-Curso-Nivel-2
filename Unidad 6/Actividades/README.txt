El script de generación de base de datos (PAISES_DB) adjunto en la carpeta 'script_db' del proyecto fue generado desde 'SQL Management Studio' a partir 
de una base de datos preexistente (DISCOS_DB) en caso de no funcionar, se sugiere hacer lo siguiente para utilizar la base de datos original: 

1) Es necesario contar con 'Microsoft SQL Server Management Studio 18' y en 'New Query' ejecutar el siguiente script para generar la base de datos: 
...
2) Ajustar la cadena de conexión que se encuentra en la clase 'PaisService'