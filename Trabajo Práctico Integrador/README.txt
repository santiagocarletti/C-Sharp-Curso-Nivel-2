Requerimientos para poder ejecutar el proyecto: 
...
2) Ajustar la cadena de conexión que se encuentra en la clase 'AccesoDatos'

3) Para dar funcionalidad a la función de administrar imágenes de forma local, crear carpeta llamada 'CatalagoApp' el la ruta 'C:\' cuya referencia 
en el proyecto, se encuentra configurada en 'App.config' dentro de la bibliotaca 'presentacion'